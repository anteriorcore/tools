...
final: prev: {
  "node_modules/tree-sitter-python" = prev."node_modules/tree-sitter-python".overrideAttrs {
    patchPhase = ''
      ...
      cp -f ${./tree-sitter-prebuilds/linux-x64/tree-sitter-python.node} ./prebuilds/linux-x64/tree-sitter-python.node
    '';
  };
  "node_modules/tree-sitter-typescript" = prev."node_modules/tree-sitter-typescript".overrideAttrs {
    patchPhase = ''
      ...
      cp -f ${./tree-sitter-prebuilds/linux-x64/tree-sitter-typescript.node} ./prebuilds/linux-x64/tree-sitter-typescript.node
    '';
  };
}
